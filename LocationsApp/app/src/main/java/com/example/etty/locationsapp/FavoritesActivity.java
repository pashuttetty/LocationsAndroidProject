...
public class FavoritesActivity extends AppCompatActivity implements FavoritesFragment.OnPlaceClicked{
    ...
    public void OnPlaceSelected(String latlong, String name, String address) {
        ...
        fm.beginTransaction().replace(R.id.favorites_fragmnet_container, myMapFragment, "map" ).commit();
    }
