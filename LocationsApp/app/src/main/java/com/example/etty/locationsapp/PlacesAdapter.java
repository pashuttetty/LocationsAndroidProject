...
public class PlacesAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        cursor.setNotificationUri(context.getContentResolver(), PlacesContract.Places.CONTENT_URI);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        nameTV.setText(cursor.getString(cursor.getColumnIndex(PlacesContract.Places.NAME)));

        TextView addressTV = (TextView)view.findViewById(R.id.addressTV);
        addressTV.setText("Address: "+cursor.getString(cursor.getColumnIndex(PlacesContract.Places.ADDRESS)));

        TextView distanceTV = (TextView)view.findViewById(R.id.distanceTV);
        //TODO: dynamically switch between m to miles:
        distanceTV.setText("Distance: "+cursor.getString(cursor.getColumnIndex(PlacesContract.Places.DISTANCE))+" KM away");
        ...
        String imageAtBase64= cursor.getString(cursor.getColumnIndex(PlacesContract.Places.PHOTO));
