...
public class HistoryAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        nameTV.setText(cursor.getString(cursor.getColumnIndex(PlacesContract.History.NAME)));

        TextView addressTV = (TextView)view.findViewById(R.id.addressTV);
        addressTV.setText("Address: "+cursor.getString(cursor.getColumnIndex(PlacesContract.History.ADDRESS)));

        TextView distanceTV = (TextView)view.findViewById(R.id.distanceTV);
        //TODO: dynamically switch between m to miles:
        distanceTV.setText("Distance: "+cursor.getString(cursor.getColumnIndex(PlacesContract.History.DISTANCE))+" Meters away");
        ...
        String imageAtBase64= cursor.getString(cursor.getColumnIndex(PlacesContract.History.PHOTO));
